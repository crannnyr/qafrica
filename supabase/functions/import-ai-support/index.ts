...
async function customerTool(s:any, req:Request, name:string, a:any) {
  ...
  if (name === 'get_my_order_context') {
    ...
    const stageMap:any = {
      ...
      clearance_and_closed:{label:'Received at QAfrica HQ',description:'Your shipment has arrived at QAfrica HQ in Nigeria after clearance.'},
      received:{label:'Received at QAfrica HQ',description:'Your shipment has been received at QAfrica HQ and is ready for the final delivery or pickup step.'},
