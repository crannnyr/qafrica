...
export default function ManualSalesPage() {
    ...
    try {
      ...
      const { data: order, error: orderError } = await supabase
        ...
        .insert({
          ...
          customer_id: null, // No customer for manual sales
  ...
  if (status === 'success') {
    return (
      ...
      >
        <div className="text-center p-6 bg-white rounded-2xl border border-gray-100 shadow-lg max-w-md w-full mx-4">
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Record Manual Sale</h1>
        ...
        {product && product.is_out_of_stock && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl flex items-start gap-3">
            ...
            <p className="text-sm text-red-700">
              <strong>Out of Stock:</strong> This product has no stock available. Recording this sale will keep the negative count.
            </p>
          </div>
        )}
        ...
        {product && !product.is_out_of_stock && (
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl flex items-start gap-3">
            ...
            <div className="text-sm text-blue-700">
              <p><strong>Available Stock:</strong> {product.stock_quantity} units</p>
              <p className="mt-1">Sale will deduct from available stock automatically.</p>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-b border-gray-100 pb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setProduct(null); // Clear product when ID changes
                  }}
              ...
              <div className="sm:col-span-2">
                ...
                <div className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-gray-50 text-2xl font-bold text-orange-600">
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="button"
              onClick={() => navigate('/dashboard/products')}
              className="flex-1 px-4 py-3 border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 font-medium transition-colors"
            >
              Cancel
            </button>
            <Button
