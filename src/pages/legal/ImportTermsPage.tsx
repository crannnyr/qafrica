...
export default function ImportTermsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Import Terms & Conditions | QAFRICA"
        description="Read QAFRICA's Import Terms & Conditions, including shipping timelines and how our consolidation shipping model works."
        noindex={false}
        url="https://qafrica.store/import-terms"
      />
      ...
      <main className="container-custom max-w-3xl py-16">
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Import Terms &amp; Conditions</h1>
          {updatedAt && (
