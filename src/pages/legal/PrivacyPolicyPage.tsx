...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Privacy Policy | QAFRICA"
        description="Learn how QAFRICA collects, uses, and protects your personal data."
        noindex={false}
        url="https://qafrica.store/privacy-policy"
      />
      ...
      <footer className="border-t py-8 mt-8">
        <div className="container-custom flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          ...
          <div className="flex gap-6">
            <Link to="/privacy-policy" className="text-orange-500">Privacy Policy</Link>
