      ...
      <header className="sticky top-0 z-30 bg-white border-b border-gray-100 px-4 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link to="/importations" className="flex items-center gap-1.5 text-xs lg:text-sm text-gray-500 hover:text-gray-900 font-medium">
            <img src="/qafrica-bag-logo.svg" alt="QAFRICA" className="w-5 h-5 lg:w-6 lg:h-6 rounded-md object-cover" />
            <span className="font-bold text-gray-900 text-xs lg:text-sm">QAFRICA</span>
          </Link>
