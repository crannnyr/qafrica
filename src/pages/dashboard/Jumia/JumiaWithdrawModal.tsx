// src/pages/dashboard/Jumia/JumiaWithdrawModal.tsx
// Deliberately NOT reusing WithdrawModal.tsx — it hardcodes ₦20,000 minimum and an
// escrow notice block, both wrong for Jumia (₦10,000 minimum, no escrow concept).
// Same visual shell/animation as the main wallet modal for consistency.
...
export default function JumiaWithdrawModal({
  isOpen, savedAccount, balance, withdrawAmount, isSubmitting,
  onClose, onAmountChange, onSetMax, onWithdraw, onAddAccount, onChangeAccount,
}: Props) {
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Withdraw Jumia Earnings</h2>
            ...
            {!savedAccount ? (
              <div className="text-center py-6 space-y-4">
                ...
                <Button onClick={onAddAccount} className="bg-orange-500 hover:bg-orange-600 text-white w-full">
                  Add Bank Account
                </Button>
              </div>
            ) : (
              <div className="space-y-5">
                <div>
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <p className="text-sm font-medium text-orange-600">Available: ₦{balance.toLocaleString()}</p>
                    <button
                      onClick={onSetMax}
                  ...
                  <p className="text-xs text-gray-400 mt-1">Minimum ₦{MIN_WITHDRAWAL.toLocaleString()}</p>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 p-3 rounded-xl flex gap-3 items-start">
                  ...
                  <p className="text-xs text-blue-800 dark:text-blue-300 leading-relaxed">
                    Your request is reviewed by an admin and paid out manually to your account.
                    This isn't instant — we'll notify you once it's sent.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-100 dark:border-gray-600">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={onChangeAccount} className="text-xs text-orange-500 hover:text-orange-600 underline">
                      Change
                    </button>
                  </div>
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <Button
                    onClick={onWithdraw}
                    disabled={isSubmitting || !withdrawAmount || parseFloat(withdrawAmount) < MIN_WITHDRAWAL}
