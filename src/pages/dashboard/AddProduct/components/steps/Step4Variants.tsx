  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-gray-900 dark:text-white flex items-center gap-1">
            Product Variants
            <InfoTip text="Enable if your product comes in different options like size or colour." />
          </h2>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Add size, colour, or other options</p>
        </div>
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-xs font-medium text-gray-700 dark:text-gray-300">Enable Variants</span>
        </label>
      </div>

      {!formData.has_variants && (
        <div className="py-8 text-center text-gray-400 dark:text-gray-500 border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl">
