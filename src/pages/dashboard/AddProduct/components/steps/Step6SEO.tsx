  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm space-y-4">
        ...
        <div>
          <label className={labelClass}>
            SEO Title <span className="text-gray-400 dark:text-gray-500 font-normal">— Optional</span>
          ...
          <input type="text" value={formData.seo_title}
            ...
            maxLength={60} />
          <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1">{formData.seo_title.length}/60</p>
        </div>

        <div>
          <label className={labelClass}>
            SEO Description <span className="text-gray-400 dark:text-gray-500 font-normal">— Optional</span>
          ...
          <textarea value={formData.seo_description}
            ...
            maxLength={160} />
          <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1">{formData.seo_description.length}/160</p>
        </div>
        ...
        {(formData.seo_title || formData.name) && (
          <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-100 dark:border-gray-700">
            <p className="text-[10px] text-gray-400 dark:text-gray-500 mb-1.5 font-medium">Google preview</p>
            <p className="text-blue-600 dark:text-blue-400 text-sm font-medium truncate">
              {formData.seo_title || formData.name}
            </p>
            <p className="text-green-700 dark:text-green-400 text-[10px]">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm space-y-3">
        ...
        <label className="flex items-start gap-3 cursor-pointer p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
          <input type="checkbox" checked={formData.allowOtherSellers}
            onChange={e => set({ allowOtherSellers: e.target.checked })}
            className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-orange-500 focus:ring-orange-500 mt-0.5" />
          <div>
            ...
            <span className="text-xs text-gray-400 dark:text-gray-500">They promote it, you fulfil it, you both earn.</span>
          </div>
        </label>
        ...
        <label className="flex items-start gap-3 cursor-pointer p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
          <input type="checkbox" checked={formData.is_active}
            ...
            className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-orange-500 focus:ring-orange-500 mt-0.5" />
          <div>
            <span className="text-sm font-medium text-gray-900 dark:text-white block">Product is active</span>
            <span className="text-xs text-gray-400 dark:text-gray-500">Uncheck to save as draft — customers won't see it until activated.</span>
          </div>
        </label>
      </div>
    </div>
