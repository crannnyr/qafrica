...
export default function ImportAdminV2Broadcast() {
  ...
  if (!hasPermission('import.broadcast.send')) {
    return (
      <div className="bg-white rounded-3xl border border-gray-100 p-10 text-center">
        <ShieldCheck className="w-9 h-9 mx-auto text-gray-200" />
        <Megaphone className="w-5 h-5 mx-auto text-gray-300 mt-4" />
        <h2 className="font-black text-gray-900 mt-3">Customer Broadcasts</h2>
        <p className="text-sm text-gray-400 mt-1">
          You do not have permission to send customer broadcasts.
        </p>
      </div>
    );
  }
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gray-950 px-6 py-7 text-white">
        ...
        <div className="relative flex items-start gap-4">
          ...
          <div>
            ...
            <h2 className="text-2xl font-black tracking-tight mt-1">Customer Broadcasts</h2>
            <p className="text-sm text-gray-400 mt-1 max-w-2xl">
              Compose and send an email announcement to your import customers, with a final confirmation before anything goes out.
            </p>
          </div>
        </div>
      </div>
