    ...
    <div className="space-y-4">
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => navigate('/import-admin-v2/products/add')} className="inline-flex items-center gap-1.5 px-3 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-xs font-bold">
              ...
              {loading ? (
                ...
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3"><div className="flex items-center gap-1">
                    ...
                    <button onClick={() => navigate(`/import-admin-v2/products/edit/${product.id}`)} className="p-2 rounded-lg hover:bg-orange-50 text-orange-500" title="Edit product"><Pencil className="w-3.5 h-3.5" /></button>
